...
private:
    ...
    string productIntervalResultFileName;//the file contains the results of product-interval reperesented by index(user-index and product-index),the file is in the form of [user source-product target-product {time1,time2,...} total-number average-interval]
    string categoryIntervalResultFileName;//the file contains the results of category-interval reperesented by index(user-index and category-index),the file is in the form of [user source-category target-category {time1,time2,...} total-number average-interval]
...
public:
    ...
    void outputCategoryIntervalFile();//output categoryIntervalResult in form of file
